module car::car_shop {
    ...
    /*
        - In this function, the ShopOwnerCap is instantiated and sent to the module publisher
            - Also instantiates CarShop object
    */
    ...
    /*
        - Takes in mutable ref to CarShop b/c we're increasing its balance
        - Takes a mutable ref to the payment (amount of SUI in wallet)
        - And also takes in TxContext b/c it's creating a new car object and minting it to the sender
    */
